...
Prompt.prototype._run = function (cb) {
  ...
  var events = observe(this.rl, this);
...
Prompt.prototype.onEnd = function (state) {
  ...
  if(this.backspaceHit){
    _interactiveDebug('backspace was hit in checkbox onEnd().');
    this.rl.emit('close-this-shiz');
    _interactiveDebug('successfully closed "this" in inquirer project (CHECKBOX onEnd()).');
    this.screen.done();
