...
var Prompt = module.exports = function (question, rl, answers) {
  ...
  events.normalizedLeftKey.takeUntil(events.line).forEach(this.onLeftKey.bind(this));

  this.unsubscribe = function(){

    console.log(util.inspect(events.line));
    console.log(util.inspect(events.keypress));
    // events.line.unsubscribe();
    // events.keypress.unsubscribe();
    // this.rl.unsubscribe();
  };
