...
Prompt.prototype.onSubmit = function (value) {
  ...
  if(this.backspaceHit){
    _interactiveDebug('backspace was hit in list onSubmit().');
    // this.events.keypress.unsubscribe();
    // this.events.line.unsubscribe();
    this.rl.emit('close-this-shiz');
    _interactiveDebug('successfully closed "this" in inquirer project (LIST onSubmit()).');
    this.screen.done();
